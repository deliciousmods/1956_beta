...
5. All graphics must use DXT5 compression and be dds format, as per the Nvidia plugin. It must also follow the standard type size found in 56, which you can find by looking at the graphic files in the mod itself.
